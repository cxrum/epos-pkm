...
<template>
    ...
    >
        ...
        <div class="relative flex flex-col gap-4 p-6">
            ...
            >
                <h2 v-if="authStore.authState?.authenticated">
                    Account connected
                </h2>
                ...
                <label v-else-if="authStore.authState?.skipPrompt">
                    Authorization was skipped. Cross-device data sync remains
                    unavailable.
                </label>
                <label v-else>
                    Authorization was deferred for this session. You can
        ...
        <BaseDialog :open="skipDialogOpen" @close="closeSkipDialog">
            <div class="flex flex-col gap-2">
                ...
                <label>
                    Without authorization, cross-device data sync is
                    unavailable.
                </label>
            </div>
