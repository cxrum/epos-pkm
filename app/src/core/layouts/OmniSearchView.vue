...
const { floatingStyles: filterOptionsStyles } = useFloating(filterOptionsButtonRef, filterOptionsRef, {
...
const { floatingStyles: sortOptionsStyles } = useFloating(sortOptionsButtonRef, sortOptionsRef, {
    placement: 'bottom-end',
    middleware: [
        offset(8),
    ],
...
<template>
    <div class="flex flex-col w-1/2 h-1/4 ьшт bg-(--bg-omnisearh) rounded-md border border-(--border) items-center shadow-md">
        
        <div class="flex justify-start items-center w-full p-2 gap-2 border-b border-(--border)">
            ...
            <BaseIcon 
                size="24px"
                class="shrink-0"
                interactive @click="togleFilterOptions"
            ...
            <BaseIcon 
                ...
                interactive @click="togleSortOptions">
                <SortAllt/>
            </BaseIcon>
